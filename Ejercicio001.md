...
MocksUps; !<li><a href="file:///C:/Users/u_38016571/Pictures/MockUp%201.png">MocksUps</a></li>
Recursos; 
<!DOCTYPE html>
<html>
	<!-- ================================================================================================================ -->
	...
	<head>
		...
		<title>Portfolio | RAY 2018</title>
		...
		<link rel="shortcut icon" href="file:///C:/Users/u_38016571/Desktop/1%203D%20Vega%20Becerra,%20Daniel/RAY/RAY2018/resources/image/ico/2880885_0.jpeg">
	</head>
	<!-- ================================================================================================================ -->
	...
	<body style="background-image:url(https://www.pcgamesn.com/wp-content/uploads/2018/07/Hammond1.jpg); background-attachment: fixed;">
		<!-- ================================================================================================================ -->
		<!-- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -->
		<header id="header">
			<div class="container">
				...
				<div class="container">
					...
					<div class="navbar-header">
						...
						<a class="navbar-brand" href="../index.html">
							<h1><img src="https://i.etsystatic.com/14590132/r/il/c457b4/1582421108/il_570xN.1582421108_t2qh.jpg" width="50" height="50" alt="logo"></h1>
						</a>
					</div>
					...
					<div class="collapse navbar-collapse">
						<ul class="nav navbar-nav navbar-right">
							<li class="active"><a href="../index.html">Hammond</a></li>

							<li class="dropdown"><a href="">Lore<i class="fa fa-angle-down"></i></a>
								<ul role="menu" class="sub-menu">
									<li><a href="file:///C:/Users/u_38016571/Desktop/1%203D%20Vega%20Becerra,%20Daniel/RAY/RAY2018/.index.html">Descrippción</a></li>
									<!--
							...
							<li class="dropdown"><a href="">RAY2018<i class="fa fa-angle-down"></i></a>
								<ul role="menu" class="sub-menu">
							...
							<li class="dropdown"><a href="">Galeria<i class=""></i></a>
							...
							<li><a href="cheetsheet.html ">Botones</a></li>
						</ul>
					</div>
			...
			<div class="container">
				<div class="row">
					<div class="main-slider">
						...
						<img src="https://d1u5p3l4wpay3k.cloudfront.net/overwatch_gamepedia/9/9b/Wrecking_Ball.png?version=fce17ad6e00794f4992022dae7e3f301" width="600" height="500" class="slider-hill" alt="slider image">
					</div>
				</div>
			</div>
